...
------|------|:-------:|-------------
`action` | [Action][action] | *optional* | If specified, this action will be invoked every interval ticks.
`rising_action` | [Action][action] | *optional* | If specified, this action will be invoked in the first interval tick the power was active.
`falling_action` | [Action][action] | *optional* | If specified, this action will be invoked in the first interval tick the power was inactive.
`interval` | [Int Provider][int_provider]  | `20` | Determines the period for which this power will tick. The provided integer is automatically clamped within the range of 0 and 2,147,483,647.
